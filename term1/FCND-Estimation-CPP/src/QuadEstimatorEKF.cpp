...
MatrixXf QuadEstimatorEKF::GetRbgPrime(float roll, float pitch, float yaw)
{
  ...
  RbgPrime(0,0) = - cTh * sPs;
  RbgPrime(0,1) = - sPh * sTh * sPs - cTh * cPs;
  RbgPrime(0,2) = - cPh * sTh * sPs + sPh * cPs;
  
  RbgPrime(1,0) = cTh * cPs;
  RbgPrime(1,1) = sPh * sTh * cPs - cPh * sPs;
  RbgPrime(1,2) = cPh * sTh * cPs + sPh * sPs;
