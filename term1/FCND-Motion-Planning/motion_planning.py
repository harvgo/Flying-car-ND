...
class MotionPlanning(Drone):
    ...
    def plan_path(self):
        ...
        filename = open("colliders.csv", "r")
        lat_str,lon_str = filename.readline().split(',')
        ...
        print('global lat: {0}, global long: {1}, global alt: {2}'.format(global_position[0],
global_position[1], global_position[2]))
        ...
        goal_n = random.randint(-north_offset, north_max)
        goal_e = random.randint(-east_offset, east_max)
        while grid[goal_n, goal_e] == 1:
            goal_n = random.randint(-north_offset, north_max)
            goal_e = random.randint(-east_offset, east_max)
